    ...
    <div>
      ...
      <div className="min-h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.04] bg-grid-black/[0.08] relative flex items-center justify-center">
        ...
        <div className="ibm-plex-mono-light flex flex-col items-center justify-center text-center px-4">
          <div>
            <h2 className="uppercase text-sm md:text-base lg:text-lg flex items-center justify-center">
          ...
          <div className="mt-4 md:mt-6 lg:mt-8">
            <TextGenerateEffect
              ...
              className="text-xl md:text-3xl lg:text-5xl sm:text-2xl"
            />
          </div>
          <div className="mt-4 md:mt-6 lg:mt-8">
            <h3 className="ibm-plex-mono-bold text-sm md:text-base lg:text-lg uppercase text-[#535562]">
