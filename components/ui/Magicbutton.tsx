...
const Magicbutton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <span className="transition ease-in-out delay-150 duration-500 hover:bg-gradient-custom2 inline-flex h-full w-full cursor-pointer items-center justify-center bg-slate-950 text-sm font-medium text-white text-opacity-70 backdrop-blur-3xl bg-gradient-custom px-8 py-4 rounded-xl gap-4">
        See More About Us{" "}
        <ArrowForwardIcon
