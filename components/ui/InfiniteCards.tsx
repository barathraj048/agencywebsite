  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[90vw] sm:w-[80vw] md:w-[60vw] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-800 p-4 sm:p-5 md:p-8"
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-4 sm:mt-6 flex flex-row items-center">
                ...
                <span className="flex flex-col gap-1">
                  <span className="text-lg sm:text-xl font-bold leading-[1.6] text-white">
                    {item.name}
                  </span>
